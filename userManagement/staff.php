	...
	<body id="kt_body" class="sidebar-enabled">
		...
		<div class="d-flex flex-column flex-root">
			...
			<div class="page d-flex flex-row flex-column-fluid">
										...
										<div data-kt-menu-trigger="click" class="menu-item here show menu-accordion mb-1">
											...
											<div class="menu-sub menu-sub-accordion">
												<div data-kt-menu-trigger="click" class="menu-item here show menu-accordion mb-1">
													...
													<div class="menu-sub menu-sub-accordion">
														<div class="menu-item">
															<a class="menu-link active" href="../../demo3/dist/apps/user-management/users/list.html">
																<span class="menu-bullet">
																	<span class="bullet bullet-dot"></span>
																</span>
				...
				<!--end::Aside-->
				<!--begin::Wrapper-->
				<div class="flex-column flex-row-fluid" style="width: 100%; margin-left: 20%;" id="kt_wrapper">
					<!--begin::Header-->
								...
								<div class="card-header border-0 pt-6">
									...
									<div class="card-toolbar">
										...
										<div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
											...
											<!--end::Filter-->
											<!--begin::Export-->
											<a href="export.html" class="btn btn-light-primary me-3">
											...
											<!--end::Export-->
											<!--begin::Add user-->
											<a href="./Users/sign-up.html" class="btn btn-primary">
									...
									<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
										...
										<tbody class="text-gray-600 fw-bold">
											...
											<tr>
												...
												<!--begin::Two step=-->
												<td>
													<div class="badge badge-light-success fw-bolder">BSC</div>
												</td>
