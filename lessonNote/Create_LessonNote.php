					...
					<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
                        ...
                        ?>
                                        ...
                                        <div class="fv-row mb-5">
                                            ...
                                            <select  class="form-control form-control-lg form-control-solid" name="subject" autocomplete="off">
                                        ...
                                        <div class="fv-row mb-5">
                                            ...
                                            <textarea class="form-control form-control-lg form-control-solid" name="desc"  placeholder="Subject Description--"></textarea>
                                            </select>
                                        </div>
